...
<h4 id="valido${[i]+1}"></h4><h3>${[i]}. ${carrito[i].nombre}</h3><h2><i class="${carrito[i].codi} ${carrito[i].icono}"></i></h2>
<div class="con-todo" >
<button class="bt-1" onclick="copy(${[i]+1})"><textarea readonly="readonly" id="${[i]+1}"  cols="35" rows="1"><i class="${carrito[i].codi} ${carrito[i].icono}"></i></textarea>
